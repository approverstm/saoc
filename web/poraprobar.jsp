<%-- 
    Document   : poraprobar
    Created on : 24-03-2017, 02:58:19 PM
    Author     : Scott
--%>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div><h1><%=poraprobar%> <small style="color: #fff"> Por Aprobar</small></h1></div>
                    </div>
                    <%}
                    } catch (Exception e) {
                        e.printStackTrace();
                        ...
                        <div class="table-responsive">   
                            <table class="table table-hover">
                              ...
                              <tbody class="buscar text-center">
                                <%
                                ResultSet aux;
                                if (vis != null){aux = d.visPoraprobar();}
                                else{aux = d.impPoraprobar(u);}
                        
                                try {
                                    while (aux.next()){
                                        System.out.println("ID_MAEDO");
                                        idmaeedo = aux.getString(1);
                                        System.out.println(idmaeedo);
                                                  ...
                                                  <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5 col-md-5">
                                                            <div class="panel panel-default">
                                                                <div class="panel-body">
                                                                    <% BigDecimal x = d.round(vanedo);%>
                                                                    <div class="text-left">
                                                                      <label class="col-sm-3 col-md-5 control-label">Subtotal</label>
                                                                      <div class="col-sm-9 col-md-7">
                                                                          <label type="text" class="form-control">$ <%=x%></label>
                                                                      </div>
                                                                    </div>
                                                                    <div class="text-left">
