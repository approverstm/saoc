<%-- 
    Document   : rechazadas
    Created on : 24-03-2017, 02:58:12 PM
    Author     : Scott
--%>
        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
              <ul class="nav navbar-nav">
                    ...
                    <li class="active-d"><a href="rechazadas.jsp"><b>Rechazadas</b></a></li>
              </ul>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div><h1><%=rechazadas%> <small style="color: #fff"> Rechazadas</small></h1></div>
                    </div>
                    <%}
                    } catch (Exception e) {
                        e.printStackTrace();
                    ...
                    <div class="table-responsive">   
                        <table class="table table-hover">
                          ...
                          <tbody class="buscar text-center">
                            <%        
                            ResultSet aux;
                            if (vis != null){aux = d.visRechazadas();}
                            else{aux = d.impRechazadas(u);}
